...
*/
// The bellow is the walker for this wighet.
...
// The wiget for displaying a list of the taxonomies
class tg29359_Widget_Taxonomies extends WP_Widget
{
    ...
    public function __construct()
    {
        if (!is_textdomain_loaded('tg29359-taxonomy-widget')) {
            load_plugin_textdomain('tg29359-taxonomy-widget');
        }
...
?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Title:' , 'tg29359-taxonomy-widget'); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('dropdown'); ?>"><?php _e( 'Display as dropdown' , 'tg29359-taxonomy-widget'); ?></label>
            <br />
            <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id('hierarchical'); ?>" name="<?php echo $this->get_field_name('hierarchical'); ?>"<?php checked( $hierarchical ); ?> />
            <label for="<?php echo $this->get_field_id('hierarchical'); ?>"><?php _e( 'Show hierarchy' , 'tg29359-taxonomy-widget'); ?></label>
            <br />
            <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id('count'); ?>" name="<?php echo $this->get_field_name('count'); ?>"<?php checked( $count ); ?> />
            <label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( 'Show post counts' , 'tg29359-taxonomy-widget'); ?></label>
            <br />
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'taxonomy' ); ?>"><?php _e( 'Taxonomy:' , 'tg29359-taxonomy-widget'); ?></label><br />
        ...
        <p>
            ...
            <select name="<?php echo $this->get_field_name('orderby'); ?>" class="widefat">
                <option value="name"       <?php selected('name'      , $instance['orderby']); ?>><?php _e('Name'                                 , 'tg29359-taxonomy-widget'); ?></option>
                <option value="ID"         <?php selected('ID'        , $instance['orderby']); ?>><?php _e('ID'        , 'tg29359-taxonomy-widget'); ?></option>
                <option value="slug"       <?php selected('slug'      , $instance['orderby']); ?>><?php _e('Slug'                                 , 'tg29359-taxonomy-widget'); ?></option>
                ...
                <option value="menu_order" <?php selected('menu_order', $instance['orderby']); ?>><?php _e('Menu order', 'tg29359-taxonomy-widget'); ?></option>
            </select>
        ...
        <p>
            <label for="<?php echo $this->get_field_name('order'); ?>"><?php _e('Sort Order:', 'tg29359-taxonomy-widget'); ?></label>
            <select name="<?php echo $this->get_field_name( 'order' ); ?>" class="widefat">
                <option value="ASC"  <?php selected('ASC' , $instance['order']); ?>><?php _e('Ascending' , 'tg29359-taxonomy-widget'); ?></option>
                <option value="DESC" <?php selected('DESC', $instance['order']); ?>><?php _e('Descending', 'tg29359-taxonomy-widget'); ?></option>
            </select>
            <span><?php _e('*Sorry, this feature does not work yet, at least with the plugin "Category Order and Taxonomy Terms Order".', 'tg29359-taxonomy-widget'); ?></span>
        </p>
<?php
